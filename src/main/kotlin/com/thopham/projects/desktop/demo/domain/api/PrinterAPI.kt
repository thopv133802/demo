...
class PrinterAPI {
    ...
    fun print(printer: Printer, url: String, copies: Int = 1){
        Platform.runLater {
    ...
    fun printTea(printer: Printer, url: String, copies: Int = 1){
        printTea(printer, url, copies, 40.0, 30.0, Units.MM)
    }
    fun printTea(printer: Printer, url: String, copies: Int = 1, width: Double, height: Double, units: Units){
        Platform.runLater {
            val printerService = fetchPrinterService(printer)
            val printerJob = PrinterJob.createPrinterJob(printerService)
